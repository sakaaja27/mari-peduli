...
export default function PertanyaanSection() {
  ...
  return (
    <section id="pertanyaan" className="pt-14 relative z-30 transition-all duration-1000 ease-in-out flex flex-col md:flex-row items-center justify-center gap-8 mb-12 px-4 w-full">
